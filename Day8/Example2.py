...
class Department:
    ...
    def promote(self,employee:Employee,new_salary):

        print(f"Old Work :\n{employee.work()}\nSalary: {employee.salary}")
        self.employees.remove(employee)
        employee.role=input("Enter the Employee's New Role :")
        employee.salary=float(input("Enter the Employee's New Salary :"))
        self.employees.append(employee)
